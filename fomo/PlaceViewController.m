...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (scrollView == _scrollView){
        ...
        self.reviewStream.view.frame = CGRectMake(self.reviewStream.view.frame.origin.x, -150 - scrollView.contentOffset.y*.75, self.reviewStream.view.frame.size.width, self.reviewStream.view.frame.size.height - scrollView.contentOffset.y);
