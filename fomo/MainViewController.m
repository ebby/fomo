...
{
    //[self.navigationController pushViewController:self.captureViewController animated:YES];
    [self presentViewController:self.addFlowViewController  animated:YES completion:nil];
}
