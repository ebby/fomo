...
@interface ThumbViewController () <PBJVideoPlayerControllerDelegate>
{
...
//    if (_post.place) {
//        [emotionButton setAttributedTitle:[[NSAttributedString alloc] initWithString:@"Glasslands Gallery" attributes:underlineAttribute] forState:UIControlStateNormal];
//    } else if (_post.emotion) {
...
//    
//    CGSize stringsize = [emotionButton.titleLabel.text sizeWithAttributes:@{NSFontAttributeName:emotionButton.titleLabel.font}];
